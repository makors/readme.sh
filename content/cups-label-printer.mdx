...
Shortly after I took a roughly 20 minute break to rethink everything, I decided to take another look at the GitHub repository in the Hackaday post which supports my Polono PL60. There was one caveat: no instructions were provided, so I was *still* helpless.
